...
What to do when a particular thing happens. Each of these is written for the
moment it is needed — short, and assuming you are in a hurry.
...
If none of these fits, the readiness list on the dashboard is the general answer:
it says what is not working, and what to do about each item.
